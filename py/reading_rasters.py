...
data_sets = {
    ...
    ,'Education' : rioxarray.open_rasterio(inputs["Education"])
    ,'Healthcare' : rioxarray.open_rasterio(inputs["Healthcare"])
    ,'Public_service' : rioxarray.open_rasterio(inputs["Public_service"])
    ,'Sustenance' : rioxarray.open_rasterio(inputs["Sustenance"])
    #####
